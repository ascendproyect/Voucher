...
import dev.hely.voucher.lib.menu.pagination.button.PageButton;
import dev.hely.voucher.lib.menu.pagination.button.PageInfoButton;
...
public abstract class PaginatedMenu extends Menu {
    ...
    @Override
    public final Map<Integer, Button> getMenuContent(Player player) {
