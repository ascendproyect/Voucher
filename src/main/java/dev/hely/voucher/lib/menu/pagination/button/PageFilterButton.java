...
import dev.hely.voucher.lib.menu.pagination.FilterablePaginatedMenu;
import dev.hely.voucher.lib.menu.pagination.PageFilter;
...
public class PageFilterButton<T> extends Button {
    ...
    public ItemStack getItemStack(Player player) {
        ...
        lore.add("");
        return ItemMaker.of(Material.HOPPER).setDisplayName("&7Filters").setLore(lore).build();
    }
    @Override
